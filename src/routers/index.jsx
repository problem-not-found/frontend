...
const router = createBrowserRouter([
  ...
  {
    path: "/write-review/:exhibitionId",
    element: (
      <AuthGuard>
        <WriteReviewPage />
      </AuthGuard>
  ...
  {
    path: "/exhibition/upload",
    element: (
      <AuthGuard>
        <ExhibitionUploadPage />
      </AuthGuard>
    ),
  },
  {
  ...
  },
  {
    ...
    element: (
      <AuthGuard>
        <ExhibitionParticipantPage />
      </AuthGuard>
    ),
  },
  {
    path: "/exhibition/offline-location",
    element: (
      <AuthGuard>
        <OfflineLocationPage />
      </AuthGuard>
  ...
  {
    path: "/exhibition/date-picker",
    element: (
      <AuthGuard>
        <ExhibitionDatePicker />
      </AuthGuard>
    ),
  },
]);
